<?php
    class controller_auth {
        ...
        function register() {
            echo json_encode(common::load_model('auth_model', 'get_register', [$_POST['username'], $_POST['password'], $_POST['email']]));
        }
        ...
        function data_user() {
            echo json_encode(common::load_model('auth_model', 'get_data_user', $_POST['token']));
        }
