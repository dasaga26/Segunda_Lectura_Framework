...
class auth_dao
{
    ...
    public function insert_user($db, $id, $username_reg, $hashed_pass, $email_reg, $avatar, $token_email)
    {
        ...
        $sql = "INSERT INTO users (uid, username, password, email, user_type, avatar, token_email, activate) VALUES ('$id', '$username_reg', '$hashed_pass', '$email_reg', 'client', '$avatar', '$token_email', 0)";
    ...
    public function select_user($db, $username, $email)
    {
        ...
        $sql = "SELECT uid, username, password, email, user_type, avatar, token_email, activate FROM users WHERE username = '$username' OR email = '$email'";
